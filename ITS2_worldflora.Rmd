...
Remove unneeded names based on ITS2_name_issues
```{r}
...
ITS2_plants <- ITS2_plants %>% 
  mutate(Species = str_replace_all(Species, "_", " ")) %>% 
  mutate(Species = replace(Species, Species == "Croton sp. BWvE-2009", "NA"), #NA`
...
write_csv(updated_ITS2_reads_WeeTU, "data_output/updated_ITS2_reads_WeeTU.csv")
```
